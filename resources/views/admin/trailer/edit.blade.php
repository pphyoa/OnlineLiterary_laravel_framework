    ...
    <form action="" method="post" enctype="multipart/form-data">         
      ...
      @csrf
        <div class="form-group">
            ...
            <input type="file" id="image" name="img" class="form-control" value="{{$trailer->img}}">
          </div>
      <div class="form-group">
        <label for="vide">အကြောင်းရာ</label>
        <textarea class="form-control" name="content" id="vide" cols="20" rows="5">{{$trailer->content}}</textarea>
      </div>
      
      <input type="submit" name="submit" class="btn btn-sm btn-right" value="ပြင်ရန်">
