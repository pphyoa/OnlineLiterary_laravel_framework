...
<div class="menu-section">
 <div class="beear">
   ...
   <div class="videpage">
    <div class="videtitle">
      <h1>Vide Title</h1>
      <a href="{{url('admin/vide/create')}}">
        <h3>Create</h3>
      </a>
    </div>
    <div class="videindex">
      @foreach ($vides as $vide)
       <div class="showingvide">
          <span><p>{{$vide->id}}</p></span>
          <img src="{{asset('uploads/'.$vide->img)}}" alt="">
          <div class="folde">
              <p>{{$vide->title}}</p>
              <p>{{$vide->author}}</p>            
          </div> 
          <div class="vider">
            {{-- <a href="{{url('admin/vide/create')}}"><p>Create</p></a> --}}
            <a href="{{url('admin/vide/edit/'.$vide->id)}}"><p>Edit</p></a>
            <a href="{{url('admin/vide/delete/'.$vide->id)}}"><p>Delete</p></a>
          </div>
       </div>              
      @endforeach
     </div>
