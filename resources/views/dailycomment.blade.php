   ...
   <div class="comment-header">
    <div class="comment-body">
      ...
      <div class="daily-comment"> 
        @if ($commentdata->user->img == null)
          <div class="comimg">
            <i class="fa fa-user"></i>
          </div>
        @else()
        <span>
          <img src="{{asset('uploads/'.$commentdata->user->img)}}" alt="">
        </span>
        @endif       
      ...
      <div class="comment-box">
        ...
        {{-- <div class="daily-comment">
            ...
            <div class="comment-box">
                <h3>Pyae Phyo aung</h3>
                <p>Pyae phyo aung is programmin student is in traingin center</p>
            </div>
        </div>
        <div class="daily-comment">
                <span>
