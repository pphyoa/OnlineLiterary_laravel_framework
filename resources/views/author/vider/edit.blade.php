    ...
    <form action="" method="post" enctype="multipart/form-data">         
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <input type="text" class="form-control" id="title" name="title" value="{{$vide->title}}">
        </div>
        <div class="col-md-6">
      ...
      <div class="form-group">
        ...
        <textarea class="form-control" name="vide" id="vide" cols="20" rows="5">{{$vide->vide}}</textarea>
      </div>
      <div class="form-group">
        <label for="image">ဓာတ်ပုံ</label>
        <input type="file" id="image" name="img" class="form-control" value="{{$vide->img}}">
      </div>
