...
class AuthorPhrasesController extends Controller
{
    /**
    ...
    {
        $id = Auth::user()->id;
        $phrases = Phrases::where('user_id',$id)->get();

        return view('author.phrases.index',compact('phrases'));
    }
    ...
    {
        $user = Auth::user();
        return view('author.phrases.create',compact('user'));
    }
    ...
    public function store(PhrasesFormRequest $request)
    {
        ...
        return redirect()->action([AuthorPhrasesController::class,'index']);
    }
    ...
    public function show($id)
    {
        ...
        return view('author.phrases.show',compact('phrases','user','likes','comments'));
    }
    ...
    public function edit($id)
    {
        $phrases = Phrases::find($id);
        $user = Auth::user();
        return view('author.phrases.edit',compact('phrases','user'));
    }
    ...
    public function like($id)
    {
        $phrases = Phrases::find($id);
        $likes = $phrases->likes;
        return view('author.phrases.authorlike',compact('phrases','likes'));
    }
    public function comment($id)
    {
        $phrases = Phrases::find($id);
        $comments = $phrases->comments; 
        return view('author.phrases.authorcomment',compact('phrases','comments'));
    }
}
